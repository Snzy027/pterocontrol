...
var userid = message.author.id;
    ...
    .setColor("FF0009")
    .setAuthor("LuxuryControl ¦ Registration", client.user.avatarURL()) 
         ...
         let embed = new Discord.MessageEmbed()
           ...
           if (result.length == 0) return message.channel.send(embed);
               ...
               let embed1 = new Discord.MessageEmbed()
                  ...
                  .setFooter(`💕LuxuryControl | https://discord.link/luxury\nRequested By ➤ ${message.author.tag}`, client.user.avatarURL())
                  .setAuthor("LuxuryControl ¦ Registration", client.user.avatarURL())
                  .setDescription("**__What Is LuxuryControl__**```LuxuryControl is a simple discord bot which allows users to manage there pterodactyl servers within discord```**__Support Links__**\n**[Youtube](https://m.youtube.com/channel/UChjN4G3gnyn8F7FUo-WRQpA)**\n**[Github](https://github.com/AcktarOfficial)**\n**[Support Server](https://discord.gg/KCuZQgA)**")
